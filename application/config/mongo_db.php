...
$config['mongo_db']['active'] = 'default'; // určuje názov konkretneho pripojenia - vhodné pri využití viac databáz
$config['mongo_db']['default']['no_auth'] = true;
$config['mongo_db']['default']['hostname'] = 'localhost'; // určuje že využívame lokálny server
$config['mongo_db']['default']['port'] = '27017'; // port pre komunikáciu
$config['mongo_db']['default']['username'] = '';
$config['mongo_db']['default']['password'] = '';
$config['mongo_db']['default']['database'] = 'donaska_jedla'; // názov databázy na kotrú sa má pripojiť
